...
type Node struct {
	...
	Maintenance   bool                   `protobuf:"varint,9,opt,name=maintenance,proto3" json:"maintenance,omitempty"`
...
type NodeServiceGetProfilingRequest struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}

func (x *NodeServiceGetProfilingRequest) Reset() {
	*x = NodeServiceGetProfilingRequest{}
	mi := &file_aquarium_v2_node_proto_msgTypes[13]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *NodeServiceGetProfilingRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*NodeServiceGetProfilingRequest) ProtoMessage() {}

func (x *NodeServiceGetProfilingRequest) ProtoReflect() protoreflect.Message {
	mi := &file_aquarium_v2_node_proto_msgTypes[13]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use NodeServiceGetProfilingRequest.ProtoReflect.Descriptor instead.
func (*NodeServiceGetProfilingRequest) Descriptor() ([]byte, []int) {
	return file_aquarium_v2_node_proto_rawDescGZIP(), []int{13}
}

type NodeServiceGetProfilingResponse struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Status        bool                   `protobuf:"varint,1,opt,name=status,proto3" json:"status,omitempty"`
	Message       string                 `protobuf:"bytes,2,opt,name=message,proto3" json:"message,omitempty"`
...
func (x *NodeServiceGetProfilingResponse) Reset() {
	*x = NodeServiceGetProfilingResponse{}
	mi := &file_aquarium_v2_node_proto_msgTypes[14]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}

func (x *NodeServiceGetProfilingResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*NodeServiceGetProfilingResponse) ProtoMessage() {}

func (x *NodeServiceGetProfilingResponse) ProtoReflect() protoreflect.Message {
	mi := &file_aquarium_v2_node_proto_msgTypes[14]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use NodeServiceGetProfilingResponse.ProtoReflect.Descriptor instead.
func (*NodeServiceGetProfilingResponse) Descriptor() ([]byte, []int) {
	return file_aquarium_v2_node_proto_rawDescGZIP(), []int{14}
}

func (x *NodeServiceGetProfilingResponse) GetStatus() bool {
	if x != nil {
		return x.Status
	}
	return false
...
func (x *NodeServiceGetProfilingResponse) GetMessage() string {
	if x != nil {
		return x.Message
	}
	return ""
...
func (x *NodeServiceGetProfilingResponse) GetData() map[string]string {
	if x != nil {
		return x.Data
	}
	return nil
...
const file_aquarium_v2_node_proto_rawDesc = "" +
	"\n" +
	"\x16aquarium/v2/node.proto\x12\vaquarium.v2\x1a\x1fgoogle/protobuf/timestamp.proto\"\xc9\x03\n" +
	"\x04Node\x12\x10\n" +
	...
	"\x06pubkey\x18\b \x01(\fR\x06pubkey\x12 \n" +
	"\vmaintenance\x18\t \x01(\bR\vmaintenance\x12;\n" +
	"\bmetadata\x18\n" +
	" \x03(\v2\x1f.aquarium.v2.Node.MetadataEntryR\bmetadata\x1a;\n" +
	...
	"\x06status\x18\x01 \x01(\bR\x06status\x12\x18\n" +
	"\amessage\x18\x02 \x01(\tR\amessage\x12%\n" +
	"\x04data\x18\x03 \x01(\v2\x11.aquarium.v2.NodeR\x04data\"D\n" +
	" NodeServiceSetMaintenanceRequest\x12 \n" +
	"\vmaintenance\x18\x01 \x01(\bR\vmaintenance\"U\n" +
	"!NodeServiceSetMaintenanceResponse\x12\x16\n" +
	"\x06status\x18\x01 \x01(\bR\x06status\x12\x18\n" +
	"\amessage\x18\x02 \x01(\tR\amessage\" \n" +
	"\x1eNodeServiceGetProfilingRequest\"\xd8\x01\n" +
	"\x1fNodeServiceGetProfilingResponse\x12\x16\n" +
	"\x06status\x18\x01 \x01(\bR\x06status\x12\x18\n" +
	"\amessage\x18\x02 \x01(\tR\amessage\x12J\n" +
	"\x04data\x18\x03 \x03(\v26.aquarium.v2.NodeServiceGetProfilingResponse.DataEntryR\x04data\x1a7\n" +
	"\tDataEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12\x14\n" +
	...
	"\x0eSetMaintenance\x12-.aquarium.v2.NodeServiceSetMaintenanceRequest\x1a..aquarium.v2.NodeServiceSetMaintenanceResponse\"\x00\x12k\n" +
	"\fGetProfiling\x12+.aquarium.v2.NodeServiceGetProfilingRequest\x1a,.aquarium.v2.NodeServiceGetProfilingResponse\"\x00BIZGgithub.com/adobe/aquarium-fish/lib/rpc/gen/proto/aquarium/v2;aquariumv2b\x06proto3"
...
var file_aquarium_v2_node_proto_msgTypes = make([]protoimpl.MessageInfo, 18)
var file_aquarium_v2_node_proto_goTypes = []any{
	...
	(*NodeServiceGetProfilingRequest)(nil),    // 13: aquarium.v2.NodeServiceGetProfilingRequest
	(*NodeServiceGetProfilingResponse)(nil),   // 14: aquarium.v2.NodeServiceGetProfilingResponse
	nil,                                       // 15: aquarium.v2.Node.MetadataEntry
	nil,                                       // 16: aquarium.v2.NodeDefinition.DisksEntry
	nil,                                       // 17: aquarium.v2.NodeServiceGetProfilingResponse.DataEntry
	(*timestamppb.Timestamp)(nil),             // 18: google.protobuf.Timestamp
}
var file_aquarium_v2_node_proto_depIdxs = []int32{
	18, // 0: aquarium.v2.Node.created_at:type_name -> google.protobuf.Timestamp
	18, // 1: aquarium.v2.Node.updated_at:type_name -> google.protobuf.Timestamp
	1,  // 2: aquarium.v2.Node.definition:type_name -> aquarium.v2.NodeDefinition
	15, // 3: aquarium.v2.Node.metadata:type_name -> aquarium.v2.Node.MetadataEntry
	2,  // 4: aquarium.v2.NodeDefinition.host:type_name -> aquarium.v2.HostInfo
	3,  // 5: aquarium.v2.NodeDefinition.memory:type_name -> aquarium.v2.MemoryInfo
	4,  // 6: aquarium.v2.NodeDefinition.cpu:type_name -> aquarium.v2.CpuInfo
	16, // 7: aquarium.v2.NodeDefinition.disks:type_name -> aquarium.v2.NodeDefinition.DisksEntry
	6,  // 8: aquarium.v2.NodeDefinition.nets:type_name -> aquarium.v2.NetworkInterface
	0,  // 9: aquarium.v2.NodeServiceListResponse.data:type_name -> aquarium.v2.Node
	0,  // 10: aquarium.v2.NodeServiceGetThisResponse.data:type_name -> aquarium.v2.Node
	17, // 11: aquarium.v2.NodeServiceGetProfilingResponse.data:type_name -> aquarium.v2.NodeServiceGetProfilingResponse.DataEntry
	5,  // 12: aquarium.v2.NodeDefinition.DisksEntry.value:type_name -> aquarium.v2.DiskUsage
	7,  // 13: aquarium.v2.NodeService.List:input_type -> aquarium.v2.NodeServiceListRequest
	9,  // 14: aquarium.v2.NodeService.GetThis:input_type -> aquarium.v2.NodeServiceGetThisRequest
	11, // 15: aquarium.v2.NodeService.SetMaintenance:input_type -> aquarium.v2.NodeServiceSetMaintenanceRequest
	13, // 16: aquarium.v2.NodeService.GetProfiling:input_type -> aquarium.v2.NodeServiceGetProfilingRequest
	8,  // 17: aquarium.v2.NodeService.List:output_type -> aquarium.v2.NodeServiceListResponse
	10, // 18: aquarium.v2.NodeService.GetThis:output_type -> aquarium.v2.NodeServiceGetThisResponse
	12, // 19: aquarium.v2.NodeService.SetMaintenance:output_type -> aquarium.v2.NodeServiceSetMaintenanceResponse
	14, // 20: aquarium.v2.NodeService.GetProfiling:output_type -> aquarium.v2.NodeServiceGetProfilingResponse
