...
const (
	...
	// NodeServiceGetProfilingProcedure is the fully-qualified name of the NodeService's GetProfiling
	// RPC.
	NodeServiceGetProfilingProcedure = "/aquarium.v2.NodeService/GetProfiling"
)
...
type NodeServiceClient interface {
	...
	// Get profiling data
	GetProfiling(context.Context, *connect.Request[v2.NodeServiceGetProfilingRequest]) (*connect.Response[v2.NodeServiceGetProfilingResponse], error)
}
...
func NewNodeServiceClient(httpClient connect.HTTPClient, baseURL string, opts ...connect.ClientOption) NodeServiceClient {
	...
	return &nodeServiceClient{
		...
		getProfiling: connect.NewClient[v2.NodeServiceGetProfilingRequest, v2.NodeServiceGetProfilingResponse](
			httpClient,
			baseURL+NodeServiceGetProfilingProcedure,
			connect.WithSchema(nodeServiceMethods.ByName("GetProfiling")),
			connect.WithClientOptions(opts...),
		),
	}
}
...
type nodeServiceClient struct {
	...
	getProfiling   *connect.Client[v2.NodeServiceGetProfilingRequest, v2.NodeServiceGetProfilingResponse]
}
...
// GetProfiling calls aquarium.v2.NodeService.GetProfiling.
func (c *nodeServiceClient) GetProfiling(ctx context.Context, req *connect.Request[v2.NodeServiceGetProfilingRequest]) (*connect.Response[v2.NodeServiceGetProfilingResponse], error) {
	return c.getProfiling.CallUnary(ctx, req)
}
...
func NewNodeServiceHandler(svc NodeServiceHandler, opts ...connect.HandlerOption) (string, http.Handler) {
	...
	nodeServiceGetProfilingHandler := connect.NewUnaryHandler(
		NodeServiceGetProfilingProcedure,
		svc.GetProfiling,
		connect.WithSchema(nodeServiceMethods.ByName("GetProfiling")),
		connect.WithHandlerOptions(opts...),
	)
	return "/aquarium.v2.NodeService/", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		...
		case NodeServiceGetProfilingProcedure:
			nodeServiceGetProfilingHandler.ServeHTTP(w, r)
		default:
			http.NotFound(w, r)
		}
	})
...
func (UnimplementedNodeServiceHandler) GetProfiling(context.Context, *connect.Request[v2.NodeServiceGetProfilingRequest]) (*connect.Response[v2.NodeServiceGetProfilingResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("aquarium.v2.NodeService.GetProfiling is not implemented"))
}
