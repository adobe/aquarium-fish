...
const (
	...
	// UserServiceAssignRolesProcedure is the fully-qualified name of the UserService's AssignRoles RPC.
	UserServiceAssignRolesProcedure = "/aquarium.v2.UserService/AssignRoles"
)
...
type UserServiceClient interface {
	...
	AssignRoles(context.Context, *connect.Request[v2.UserServiceAssignRolesRequest]) (*connect.Response[v2.UserServiceAssignRolesResponse], error)
}
...
func NewUserServiceClient(httpClient connect.HTTPClient, baseURL string, opts ...connect.ClientOption) UserServiceClient {
	...
	return &userServiceClient{
		...
		assignRoles: connect.NewClient[v2.UserServiceAssignRolesRequest, v2.UserServiceAssignRolesResponse](
			httpClient,
			baseURL+UserServiceAssignRolesProcedure,
			connect.WithSchema(userServiceMethods.ByName("AssignRoles")),
			connect.WithClientOptions(opts...),
		),
	}
}
...
type userServiceClient struct {
	...
	assignRoles *connect.Client[v2.UserServiceAssignRolesRequest, v2.UserServiceAssignRolesResponse]
}
...
// AssignRoles calls aquarium.v2.UserService.AssignRoles.
func (c *userServiceClient) AssignRoles(ctx context.Context, req *connect.Request[v2.UserServiceAssignRolesRequest]) (*connect.Response[v2.UserServiceAssignRolesResponse], error) {
...
func NewUserServiceHandler(svc UserServiceHandler, opts ...connect.HandlerOption) (string, http.Handler) {
	...
	userServiceAssignRolesHandler := connect.NewUnaryHandler(
		UserServiceAssignRolesProcedure,
		svc.AssignRoles,
		connect.WithSchema(userServiceMethods.ByName("AssignRoles")),
		connect.WithHandlerOptions(opts...),
	)
	return "/aquarium.v2.UserService/", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		...
		case UserServiceAssignRolesProcedure:
			userServiceAssignRolesHandler.ServeHTTP(w, r)
		default:
			http.NotFound(w, r)
		}
	})
...
func (UnimplementedUserServiceHandler) AssignRoles(context.Context, *connect.Request[v2.UserServiceAssignRolesRequest]) (*connect.Response[v2.UserServiceAssignRolesResponse], error) {
	return nil, connect.NewError(connect.CodeUnimplemented, errors.New("aquarium.v2.UserService.AssignRoles is not implemented"))
}
