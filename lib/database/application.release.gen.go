...
func (d *Database) ApplicationDeallocate(ctx context.Context, appUID typesv2.ApplicationUID, requestor string) (*typesv2.ApplicationState, error) {
	return d.applicationDeallocateImpl(ctx, appUID, requestor)
}
