...
// DEPRECATED: Warning, this is deprecated logic to support openapi RBAC, it will be removed
...
var openapiPermissions = map[string][]types.Permission{
	"Administrator": {
...
// GetAllPermissions returns a list of permission for roles
func GetOpenAPIPermissions() map[string][]types.Permission {
	return openapiPermissions
}
