...
drivers:
  ...
  providers:
	...
	t.Run("Resource should be created with 1 in definition index", func(t *testing.T) {
		...
		if res.DefinitionIndex != 0 {
			t.Fatalf("Resource definition index is incorrect: %d != 0", res.DefinitionIndex)
		}
	})
	...
	t.Run("Resource should be created with 1 in definition index", func(t *testing.T) {
		...
		if res.DefinitionIndex != 1 {
			t.Fatalf("Resource definition index is incorrect: %d != 1", res.DefinitionIndex)
		}
	})
	...
	t.Run("Resource should be created with 1 in definition index", func(t *testing.T) {
		...
		if res.DefinitionIndex != 2 {
			t.Fatalf("Resource definition index is incorrect: %d != 2", res.DefinitionIndex)
		}
	})
