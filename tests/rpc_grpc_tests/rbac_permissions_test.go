...
drivers:
  ...
  providers:
	...
	regularCli, regularOpts := h.NewConnectClient(regularUser.Name, regularUserPass, h.ConnectClientGRPC)
	powerCli, powerOpts := h.NewConnectClient(powerUser.Name, powerUserPass, h.ConnectClientGRPC)
