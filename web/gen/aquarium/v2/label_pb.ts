...
export const file_aquarium_v2_label: GenFile = /*@__PURE__*/
  fileDesc("", [file_google_protobuf_timestamp, file_google_protobuf_struct, file_aquarium_v2_common, file_aquarium_v2_rbac]);
...
/**
 * @generated from message aquarium.v2.LabelServiceDeleteRequest
 */
export type LabelServiceDeleteRequest = Message<"aquarium.v2.LabelServiceDeleteRequest"> & {
  /**
   * @generated from field: string label_uid = 1;
   */
  labelUid: string;
...
/**
 * Describes the message aquarium.v2.LabelServiceDeleteRequest.
 * Use `create(LabelServiceDeleteRequestSchema)` to create a new message.
 */
export const LabelServiceDeleteRequestSchema: GenMessage<LabelServiceDeleteRequest> = /*@__PURE__*/
  messageDesc(file_aquarium_v2_label, 10);

/**
 * @generated from message aquarium.v2.LabelServiceDeleteResponse
 */
export type LabelServiceDeleteResponse = Message<"aquarium.v2.LabelServiceDeleteResponse"> & {
  /**
   * @generated from field: bool status = 1;
   */
  status: boolean;
...
/**
 * Describes the message aquarium.v2.LabelServiceDeleteResponse.
 * Use `create(LabelServiceDeleteResponseSchema)` to create a new message.
 */
export const LabelServiceDeleteResponseSchema: GenMessage<LabelServiceDeleteResponse> = /*@__PURE__*/
...
export const LabelService: GenService<{
  ...
  delete: {
    methodKind: "unary";
    input: typeof LabelServiceDeleteRequestSchema;
    output: typeof LabelServiceDeleteResponseSchema;
  },
}> = /*@__PURE__*/
