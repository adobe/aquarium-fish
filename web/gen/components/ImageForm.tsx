    ...
    Object.keys(nestedGetDataFns.current).forEach(key => {
      ...
      if (nestedGetData) {
        ...
        if (arrayMatch) {
          ...
          (currentFormData[fieldName as keyof ImageFormState] as any[])[index] = nestedData;
          ...
          (currentFormData[fieldName as keyof ImageFormState] as any)[mapKey] = nestedData;
        } else {
          // Regular nested field
          currentFormData[key as keyof ImageFormState] = nestedData;
        }
      }
    });
