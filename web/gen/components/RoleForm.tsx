    ...
    Object.keys(nestedGetDataFns.current).forEach(key => {
      ...
      if (nestedGetData) {
        ...
        if (arrayMatch) {
          ...
          (currentFormData[fieldName as keyof RoleFormState] as any[])[index] = nestedGetData();
          ...
          (currentFormData[fieldName as keyof RoleFormState] as any)[mapKey] = nestedGetData();
        } else {
          // Regular nested field
          currentFormData[key as keyof RoleFormState] = nestedGetData();
        }
      }
    });
...
const validateForm = (): boolean => {
  ...
  if (formData.permissions === undefined || formData.permissions === null || formData.permissions === '' || formData.permissions.length === 0) {
          ...
          return (
            <div className="pl-2">
              <NestedComponent
                ...
                nested={true}
                onRegister={(getDataFn: () => any) => registerNestedGetData('permissions[' + index + ']', getDataFn)}
              />
            </div>
          );
        }
