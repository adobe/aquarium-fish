    ...
    Object.keys(nestedGetDataFns.current).forEach(key => {
      ...
      if (nestedGetData) {
        ...
        if (arrayMatch) {
          ...
          (currentFormData[fieldName as keyof ApplicationFormState] as any[])[index] = nestedData;
          ...
          (currentFormData[fieldName as keyof ApplicationFormState] as any)[mapKey] = nestedData;
        } else {
          // Regular nested field
          currentFormData[key as keyof ApplicationFormState] = nestedData;
        }
      }
    });
