...
if [ -z "$label_id" ]; then
    label_id=$(curl -u "admin:$token" -k -X POST -H 'Content-Type: application/json' -d '{"name":"'$label'", "version":'$version', "driver":"vmx",
        "definition": {
            "image": "macos1106-ci-xcode131",
            "images": {
                "macos1106": "https://artifact-storage/aquarium/image/macos1106-VERSION/macos1106-VERSION.tar.xz",
                "macos1106-ci": "https://artifact-storage/aquarium/image/macos1106-ci-VERSION/macos1106-ci-VERSION.tar.xz",
                "macos1106-ci-xcode131": "https://artifact-storage/aquarium/image/macos1106-ci-xcode131-VERSION/macos1106-ci-xcode131-VERSION.tar.xz"
            },
            "requirements": {
                "cpu": 14,
                "ram": 12,
        ...
        "metadata": {
            "JENKINS_AGENT_WORKSPACE": "/Volumes/xcode131"
        }
