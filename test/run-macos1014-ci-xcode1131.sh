...
if [ -z "$label_id" ]; then
    label_id=$(curl -u "admin:$token" -k -X POST -H 'Content-Type: application/json' -d '{"name":"'$label'", "version":'$version', "driver":"vmx",
        "definition": {
            "image": "macos1014-ci-xcode1131",
            "images": {
                "macos1014": "https://artifact-storage/aquarium/image/macos1014-VERSION/macos1014-VERSION.tar.xz",
                "macos1014-ci": "https://artifact-storage/aquarium/image/macos1014-ci-VERSION/macos1014-ci-VERSION.tar.xz",
                "macos1014-ci-xcode1131": "https://artifact-storage/aquarium/image/macos1014-ci-xcode1131-VERSION/macos1014-ci-xcode1131-VERSION.tar.xz"
            },
            "requirements": {
                "cpu": 14,
                "ram": 12,
